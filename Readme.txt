...
5) Type in the command sh ./runP3.sh to run the sample instances for P3.lis
   The .java codes will automatically be compiled and run for 1024 and 2048 cache configs for P3.lis
...
7) Similarly run the script file for P4.lis using the terminal command sh ./runP4.sh
   The .java codes will automatically be compiled and run for 1024 and 2048 cache configs for P4.lis
   The results displayed will be for:
